package com.fc.homescreen.apidata
...
class ApiRepo {
    ...
    fun getData(type: String, context: Context): MutableLiveData<JsonObject?> {
        ...
        rejultObj.addProperty("currentimeinmillis", calulateDate(
            AppApplication.getPref(AppApplication.getInstance()!!).getString(
                "S_Time", "")!!
        ))
        ...
        rejultObj.addProperty("current_date", calulateDate(System.currentTimeMillis().toString()))
        rejultObj.addProperty("isAndroidUserSubscribed", "1")
        ...
        rejultObj.addProperty("subscriptionId", AppApplication.getPref(AppApplication.getInstance()!!).getString(
            "S_Token", ""
        ).toString())
    ...
    fun subscribePlayStore(context: Context, email: String): MutableLiveData<JsonObject?> {
        ...
        rejultObj.addProperty("subscriptionStartDate", calulateDate(
            AppApplication.getPref(AppApplication.getInstance()!!).getString(
                "S_Time", "")!!
        ))
        rejultObj.addProperty("userSubscriptionDays", calculatePeriod(""))
        /*rejultObj.addProperty("subscriptionEndDate",  calulateDate(
            AppApplication.getPref(AppApplication.getInstance()!!).getString(
                "E_Time", "")!!
        ))*/
