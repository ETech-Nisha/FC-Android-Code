package com.fc.homescreen.manager.detail
...
import com.fc.homescreen.manager.home.PermissionAccept
...
class DetailActivity : AppCompatActivity(), View.OnClickListener , PurchasesUpdatedListener, BillingClientStateListener{
