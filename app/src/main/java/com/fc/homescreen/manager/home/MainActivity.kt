...
import com.fc.homescreen.SplashActivity.Companion.LAST_SCREEN
import com.fc.homescreen.WebActivity
import com.fc.homescreen.apidata.ApiViewModel
import com.fc.homescreen.manager.alldata.AllActivity
import com.fc.homescreen.manager.detail.DetailActivity

import com.fc.homescreen.util.Screen
...
class MainActivity : AppCompatActivity(), View.OnClickListener, PurchasesUpdatedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*Log.v("Background Service::::", "Is active::" + isJobServiceOn(this))
        if (isJobServiceOn(this) == false) {
            scheduleJob(this)
        }*/
    ...
    private fun scheduleJob(context: Context) {
        ...
        val componentName = ComponentName(this, OnceADay::class.java)
        val jobInfo = JobInfo.Builder(Utility.JOB_ID, componentName)
            .setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY)
            .setPeriodic(Utility.REFRESH_INTERVAL)
            .build()
        Log.v("Background Service::::", "msg app::" + jobInfo.isPeriodic)
 ...
 */
    ...
    fun checkSub() {
        ...
        if (isPurchased) {
            getWallpaperData()
            /*if (AppApplication.getPref(AppApplication.getInstance()!!).getString("E_Time", "")
                    .equals("")
            ) {
                var mainIntent =
                    Intent(this@MainActivity, WebActivity::class.java)
